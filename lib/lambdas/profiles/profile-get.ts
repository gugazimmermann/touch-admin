...
const getOne = async (profileID: string, requestID: string, TableName: string): Promise<APIGatewayProxyResult> => {
...
const getAll = async (requestID: string, TableName: string): Promise<APIGatewayProxyResult> => {
...
const profileGet = async (event: APIGatewayEvent, requestID: string, TableName: string): Promise<APIGatewayProxyResult> => {
